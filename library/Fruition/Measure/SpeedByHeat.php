...
class Fruition_Measure_SpeedByHeat extends Zend_Measure_Abstract
{
    ...
    protected $_units = array(
        'METER_PER_GROWING_DEGREE_DAY_CELSIUS'         => array('1',                                         'm/TT'),
        'METER_PER_GROWING_DEGREE_DAY_FAHRENHEIT'      => array(array('' => '1', '/' => '0.5555555'),        'm/TTF'),
        'CENTIMETER_PER_GROWING_DEGREE_DAY_CELSIUS'    => array('0.01',                                      'cm/TT'),
        'CENTIMETER_PER_GROWING_DEGREE_DAY_FAHRENHEIT' => array(array('' => '0.01', '/' => '0.5555555'),     'cm/TTF'),
        'INCH_PER_GROWING_DEGREE_DAY_CELSIUS'          => array('0.0254',                                    'in/TT'),
        'INCH_PER_GROWING_DEGREE_DAY_FAHRENHEIT'       => array(array('' => '0.0254', '/' => '0.5555555'),   'in/TTF'),
